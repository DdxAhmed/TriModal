...
export function MentionsSection() {
  ...
  return (
    <section className="py-20 border-b border-border/30 bg-black/60 relative overflow-hidden" dir="ltr">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-12">
          <h2 className="text-sm font-mono text-primary tracking-widest mb-3 uppercase">
            // PUBLICITY_AND_MENTIONS
          </h2>
          <h3 className="text-3xl font-sans font-bold text-foreground">Featured In & Mentions</h3>
        </div>
        ...
        >
          {mentions.map((mention, i) => (
            <a
              ...
              className="group flex flex-col justify-between border border-border bg-card/10 p-6 hover:bg-black hover:border-primary/50 transition-all duration-300 relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              <div className="space-y-4">
                ...
                <h4 className="text-xl font-bold font-sans text-foreground group-hover:text-primary transition-colors">
                  {mention.title}
                </h4>
