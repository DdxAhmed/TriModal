...
export function TeamSection() {
  ...
  return (
    <section className="py-24 md:py-32 border-b border-border/30 bg-black/40 relative overflow-hidden" dir="ltr">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 text-center">
          <h2 className="text-sm font-mono text-primary tracking-widest mb-4 uppercase">
        ...
        >
          {team.map((member, index) => (
            <a 
              ...
              className="group relative border border-border bg-card/20 p-6 flex flex-col items-center text-center hover:bg-black hover:border-primary/55 transition-all duration-500 hover:shadow-[0_15px_40px_rgba(0,255,65,0.03)] cursor-pointer"
            >
              {/* Glowing top line */}
              ...
              <div className="relative w-full aspect-square bg-black border border-border/40 mb-6 flex flex-col items-center justify-center overflow-hidden group-hover:border-primary/45 transition-colors duration-500">
                ...
                {/* Laser scan line (only visible or faster on hover) */}
              ...
              <div className="space-y-2 relative z-10">
                <h4 className="text-xl font-bold font-sans text-foreground group-hover:text-primary transition-colors duration-300">
                  {member.name}
                </h4>
