...
export function TriModal() {
  ...
  return (
    <section className="py-32 md:py-48 border-b border-border/30 relative overflow-hidden bg-background" dir="ltr">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-24">
          ...
          <h3 className="text-4xl md:text-5xl font-sans font-bold text-foreground">Tri-Modal Active Sensing</h3>
        </div>
        ...
        <div ref={ref} className={`grid grid-cols-1 lg:grid-cols-3 gap-8 ${isVisible ? 'reveal-visible' : 'reveal-hidden'}`}>
          {modalities.map((mod, i) => (
            ...
            >
              <div className="absolute top-0 right-0 w-full h-[2px] bg-linear-to-l from-transparent via-primary/0 to-transparent group-hover:via-primary group-hover:shadow-[0_0_15px_hsl(var(--primary))] transition-all duration-700" />
